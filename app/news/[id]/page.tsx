...
export default function NewsDetailPage() {
  ...
  const content = {
    ar: {
      ...
      target: [
        "أبناء الجالية المصرية من جميع المراحل الدراسية.",
      ...
      faq: [
        { q: "أين يقع المركز؟", a: "يقع المركز في النادي المصري بإمارة عجمان." },
        { q: "ما هي الرسوم الدراسية؟", a: "الرسوم الدراسية تبلغ 4500 درهم للمنهج العربي و5000 درهم لمنهج اللغات." },
        { q: "كيف يمكن التسجيل؟", a: "يتم التسجيل من خلال دفع رسوم حجز مقعد بقيمة 250 درهم، وتُخصم من الرسوم الدراسية." },
        { q: "هل يوجد زي مدرسي؟", a: "نعم، يوجد زي مدرسي معتمد." },
        { q: "هل تتوفر خدمة المواصلات؟", a: "نعم، تتوفر خدمة المواصلات للطلاب." },
        { q: "متى يبدأ العام الدراسي؟", a: "يبدأ العام الدراسي في السابع من شهر سبتمبر." },
        { q: "هل يوجد خصم في حال وجود أكثر من طالب؟", a: "نعم، يوجد خصم بنسبة 10% للطالب الثاني." },
        { q: "هل يتوفر التعليم باللغة العربية واللغات الأخرى؟", a: "نعم، يتوفر التعليم باللغة العربية وباللغات الأخرى." },
        { q: "هل توفرون الكتب الدراسية أم يجب شراؤها؟", a: "نعم، نوفر جميع الكتب الدراسية اللازمة." },
      ],
      dir: "rtl"
    },
    en: {
